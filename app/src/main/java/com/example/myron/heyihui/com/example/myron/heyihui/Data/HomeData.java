...
public class HomeData {
    ...
    public class Data {
        ...
        private String ext;
        private String feecso;  //cso
        private String feedist; //配送
        private String feefin;  //代理
        private String feein;  //采集
        private int hascso;
        private int hasdist;//
        private int hasfin;//进行中订单数
        private int hasin; //需求数量
        private int id;
